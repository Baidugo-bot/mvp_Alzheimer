...
class Paciente implements TipoUsuario {
  ...
  Paciente({required this.doenca,required this.anotacoes,required this.remedios,required this.id,required this.dataNasc,required this.idUsuario,required this.nome});
